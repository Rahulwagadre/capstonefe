...
export const Checkout = () => {
    return (
        ...
        <form className="pb-10 pt-5 px-5 shadow-xl">
      <div className="space-y-12">
        ...
        <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-base/7 font-semibold text-gray-900">Existing addresses</h2>
...
{/* stacked list end  */}
          <div className="mt-10 space-y-10">
            ...
            <fieldset>
            <h2 className="text-base/7 font-semibold text-gray-900">Payment methods</h2>
